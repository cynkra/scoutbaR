...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   cacheOrExtractConfig: () => (/* binding */ cacheOrExtractConfig),
/* harmony export */   processAction: () => (/* binding */ _processAction),
/* harmony export */   setOpenState: () => (/* binding */ setOpenState),
...
var setOpenState = function setOpenState(configuration) {
  setInterval(function () {
    var actual = Shiny.shinyapp.$inputValues["".concat(configuration.id, "-open")];
    var newVal = $("#scoutbar___root").children().length > 0;
    if (actual != newVal) {
      Shiny.setInputValue("".concat(configuration.id, "-open"), newVal);
    }
  }, 100);
};
var cacheOrExtractConfig = function cacheOrExtractConfig(configuration) {
  var cachedConfig;
...
var updateConfig = function updateConfig(cachedConfig, configuration) {
  var configInputId = "".concat(configuration.id, "-configuration");
...
/***/ "./node_modules/css-loader/dist/cjs.js!./srcjs/scoutbar.css":
/*!******************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./srcjs/scoutbar.css ***!
  \******************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".scoutbar-cell-item i {\n  margin-right: 1rem;\n}", "",{"version":3,"sources":["webpack://./srcjs/scoutbar.css"],"names":[],"mappings":"AAAA;EACE,kBAAkB;AACpB","sourcesContent":[".scoutbar-cell-item i {\n  margin-right: 1rem;\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_scoutbar_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../node_modules/css-loader/dist/cjs.js!./scoutbar.css */ "./node_modules/css-loader/dist/cjs.js!./srcjs/scoutbar.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_scoutbar_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_scoutbar_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
/* harmony import */ var _scoutbar_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scoutbar.css */ "./srcjs/scoutbar.css");
...
var scoutbarInput = function scoutbarInput(_ref) {
  ...
  var cachedConfig = (0,_utils_jsx__WEBPACK_IMPORTED_MODULE_2__.cacheOrExtractConfig)(configuration);
  // Scoutbar does not seem to emit any onClose so it does not know
  // its state
  (0,_utils_jsx__WEBPACK_IMPORTED_MODULE_2__.setOpenState)(configuration);
  // Update cache key by key when necessary
  (0,_utils_jsx__WEBPACK_IMPORTED_MODULE_2__.updateConfig)(cachedConfig, configuration);
